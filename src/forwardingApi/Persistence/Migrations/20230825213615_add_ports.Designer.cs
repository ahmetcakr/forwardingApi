...
namespace Persistence.Migrations
{
    ...
    [Migration("20230825213615_add_ports")]
    partial class add_ports
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Security.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 2, 36, 125, 84, 61, 140, 191, 119, 11, 207, 98, 178, 255, 70, 245, 189, 47, 136, 176, 39, 49, 51, 251, 139, 187, 78, 74, 101, 255, 164, 97, 41, 19, 113, 117, 137, 64, 242, 80, 195, 144, 223, 113, 235, 6, 100, 36, 96, 123, 131, 45, 147, 182, 247, 227, 42, 25, 177, 203, 231, 29, 86, 76, 243 },
                            PasswordSalt = new byte[] { 42, 212, 255, 242, 231, 81, 184, 142, 110, 133, 119, 193, 135, 48, 63, 167, 49, 242, 111, 56, 62, 48, 251, 196, 13, 206, 24, 164, 59, 38, 182, 147, 45, 38, 1, 71, 43, 204, 128, 119, 82, 60, 52, 2, 118, 66, 44, 239, 69, 51, 121, 189, 120, 118, 136, 23, 145, 67, 123, 38, 211, 20, 8, 143, 165, 131, 231, 108, 43, 245, 190, 228, 230, 41, 67, 10, 216, 187, 160, 29, 155, 78, 216, 110, 117, 79, 211, 250, 104, 102, 124, 126, 167, 94, 166, 140, 162, 183, 104, 186, 172, 76, 204, 212, 46, 35, 142, 161, 161, 39, 248, 152, 23, 138, 152, 214, 241, 26, 123, 168, 199, 5, 255, 42, 203, 106, 8, 204 },
                            Status = true
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasIndex(new[] { "Id" }, "UK_Customer_ID")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.Customer", b =>
                {
                    b.HasOne("Domain.Entities.CommercialDetail", "CommercialDetail")
                        .WithMany()
                        .HasForeignKey("CommercialDetailId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Domain.Entities.CommercialType", "CommercialType")
                        .WithMany()
                        .HasForeignKey("CommercialTypeId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Domain.Entities.EBill", "EBill")
                        .WithMany()
                        .HasForeignKey("EBillId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Domain.Entities.FirmType", "FirmType")
                        .WithMany()
